(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('rxjs/Subject'), require('rxjs/BehaviorSubject'), require('rxjs/observable/timer'), require('rxjs/operators')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'rxjs/Subject', 'rxjs/BehaviorSubject', 'rxjs/observable/timer', 'rxjs/operators'], factory) :
	(factory((global['ngx-progressbar'] = global['ngx-progressbar'] || {}, global['ngx-progressbar'].core = {}),global.ng.core,global.ng.common,global.Rx,global.Rx,global.Rx.Observable,global.Rx.Observable.prototype));
}(this, (function (exports,core,common,Subject,BehaviorSubject,timer,operators) { 'use strict';
...
var NgProgressBarComponent = (function () {
    ...
    NgProgressBarComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.state$ = this.progress.state$.pipe(operators.map(function (state) { return ({
...
NgProgressComponent.propDecorators = {
    ...
    "toggleProgressbar": [{ type: core.Input, args: ['toggle',] },],
};
/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes} checked by tsc
...
exports.ɵb = NgProgressBarComponent;
exports.ɵa = NgProgressComponent;
